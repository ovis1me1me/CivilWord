import { ReactComponent as LeadingIcon } from '../../assets/Leading_Icon.png';
...
export default function HistoryHeader({ keyword, setKeyword }: HistoryHeaderProps) {
  return (
    <div
      data-state="Inactive"
      data-type="Outline"
      className="w-[931px] h-11 bg-white rounded outline outline-1 outline-offset-[-1px] outline-zinc-400 inline-flex flex-col justify-start items-start"
    >
